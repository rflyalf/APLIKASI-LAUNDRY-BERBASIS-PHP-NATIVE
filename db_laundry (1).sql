...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2025 at 05:04 AM
...
(3, 'Ryan Kalong', '085678901234', 'Jl. Pisang No. 25'),
(4, 'Naufal ', '089012345678', 'Jl. Lavender No. 50'),
(5, 'Muadz', '081678934512', 'Jl. Gacoan No. 20'),
(9, 'idham', '1234', 'A');
...
(8, '2025-01-06', 3, 21000, 3, '2025-01-07', 1),
(9, '2025-01-06', 4, 18000, 3, '2025-01-06', 1);
...
--
ALTER TABLE `pakaian`
  MODIFY `pakaian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `pakaian`
  ADD CONSTRAINT `pakaian_ibfk_1` FOREIGN KEY (`pakaian_transaksi`) REFERENCES `transaksi` (`transaksi_id`) ON DELETE CASCADE;
COMMIT;
